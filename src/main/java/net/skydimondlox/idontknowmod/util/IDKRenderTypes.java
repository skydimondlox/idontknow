...
public class IDKRenderTypes extends RenderStateShard
{
    ...
    protected static final RenderStateShard.ShaderStateShard FULLBRIGHT_BLOCKS = new RenderStateShard.ShaderStateShard(IDKGLShaders::getBlockFullbrightShader);
    protected static final RenderStateShard.ShaderStateShard POINTS_SHADER = new RenderStateShard.ShaderStateShard(IDKGLShaders::getPointShader);
    ...
    static
    {
        SOLID_FULLBRIGHT = createDefault(
                idontknowmod.MOD_ID+":solid_fullbright",
        ...
        TRANSLUCENT_FULLBRIGHT = createDefault(
                idontknowmod.MOD_ID+":translucent_fullbright",
                BLOCK_WITH_OVERLAY, Mode.QUADS,
                RenderType.CompositeState.builder()
                        .setShaderState(FULLBRIGHT_BLOCKS)
                        .setLightmapState(LIGHTMAP_DISABLED)
        ...
        RenderType.CompositeState translucentNoDepthState = RenderType.CompositeState.builder()
                ...
                .createCompositeState(false);
        LINES = createDefault(
                idontknowmod.MOD_ID+":translucent_lines", DefaultVertexFormat.POSITION_COLOR_NORMAL, Mode.LINES,
                RenderType.CompositeState.builder()
        ...
        POINTS = createDefault(
                idontknowmod.MOD_ID+":points", DefaultVertexFormat.POSITION_COLOR_NORMAL, Mode.QUADS,
                RenderType.CompositeState.builder()
        ...
        TRANSLUCENT_TRIANGLES = createDefault(
                idontknowmod.MOD_ID+":translucent_triangles", DefaultVertexFormat.POSITION_COLOR, Mode.TRIANGLES, translucentNoDepthState
        );
        ...
        TRANSLUCENT_POSITION_COLOR = createDefault(
                idontknowmod.MOD_ID+":translucent_pos_color", DefaultVertexFormat.POSITION_COLOR, Mode.QUADS, translucentNoTextureState
        );
        TRANSLUCENT_NO_DEPTH = createDefault(
                idontknowmod.MOD_ID+":translucent_no_depth", DefaultVertexFormat.POSITION_COLOR, Mode.QUADS, translucentNoDepthState
        );
        CHUNK_MARKER = createDefault(
                idontknowmod.MOD_ID+":chunk_marker",
        ...
        POSITION_COLOR_LIGHTMAP = createDefault(
                idontknowmod.MOD_ID+":pos_color_lightmap",
        ...
        ITEM_DAMAGE_BAR = createDefault(
                idontknowmod.MOD_ID+":item_damage_bar",
    ...
    private IDKRenderTypes(String p_110161_, Runnable p_110162_, Runnable p_110163_)
    {
    ...
    {
        return createDefault(
                idontknowmod.MOD_ID+":pos_tex_"+texture,
    ...
    )
    {
        return type -> in.getBuffer(new RenderType(
                idontknowmod.MOD_ID+":"+type+"_"+name,
                type.format(),
                type.mode(),
                type.bufferSize(),
