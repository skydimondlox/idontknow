...
import net.skydimondlox.idontknowmod.register.IDKParticles;
...
import net.skydimondlox.idontknowmod.util.IDKCodecs;
                             ...
                             float[] colourIn) implements ParticleOptions
{
    public static Codec<FractalOptions> CODEC = RecordCodecBuilder.create(
            instance -> instance.group(
                    IDKCodecs.VECTOR3D.fieldOf("direction").forGetter(d -> d.direction),
                    ...
                    IDKCodecs.COLOR4.fieldOf("outerColor").forGetter(d -> d.colourOut),
                    IDKCodecs.COLOR4.fieldOf("innerColor").forGetter(d -> d.colourIn)
    ...
    {
        return IDKParticles.FRACTAL.get();
    }
