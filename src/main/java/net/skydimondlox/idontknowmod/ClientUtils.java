...
import net.skydimondlox.idontknowmod.util.sound.IDKBlockEntitySound;
import net.skydimondlox.idontknowmod.mixin.accessors.client.FontResourceManagerAccess;
import net.skydimondlox.idontknowmod.mixin.accessors.client.MinecraftAccess;
...
public class ClientUtils
{
    ...
    public static IDKBlockEntitySound generatePositionedIDKSound(SoundEvent soundEvent, float volume, float pitch, BlockPos pos)
    {
        IDKBlockEntitySound sound = new IDKBlockEntitySound(soundEvent, volume, pitch, pos);
