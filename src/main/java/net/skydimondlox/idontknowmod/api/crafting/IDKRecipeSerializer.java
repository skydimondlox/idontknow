...
public abstract class IDKRecipeSerializer<R extends Recipe<?>> implements RecipeSerializer<R>
{
    ...
    protected static Lazy<ItemStack> readOutput(JsonElement outputObject)
    {
        ...
        return Lazy.of(() -> API.getPreferredStackbyMod(outgredient.getMatchingStacks()));
    }
